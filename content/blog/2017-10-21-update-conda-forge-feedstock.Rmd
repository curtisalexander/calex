...
## Summary
Utilize the instructions below to update a [conda-forge](https://conda-forge.org) [feedstock](https://github.com/conda-forge/feedstocks).
...
## What to Update?
Use [feedstockrot](https://github.com/axiom-data-science/feedstockrot) in order to determine which feedstocks one needs to update.
...
Currently[^4], I maintain the following [feedstocks](https://github.com/conda-forge/feedstocks):
