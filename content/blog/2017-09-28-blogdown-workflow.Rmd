...
Below is my general workflow for creating a blog post using [blogdown](https://bookdown.org/yihui/blogdown/) if I am building locally.  If I am making full use of automation and CI, I utilize a [ref]( `r blogdown::shortcode("ref", "blog/github-travis-netlify")` ).
