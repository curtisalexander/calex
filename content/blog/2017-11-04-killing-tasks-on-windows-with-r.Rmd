...
Below are two examples &mdash; both accomplish the same feat &mdash; that use R to call down to the OS and kill a list of tasks / applications.  An alternative impetus for writing the short scripts below was to experiment with the [processx](https://github.com/r-lib/processx) package.  A more portable


### Taskkill (Readable and Annotated)

<script src="https://gist.github.com/curtisalexander/5d328078441eb767083793faf268b27c.js"></script>

### Taskkill (Single Pipeline)
