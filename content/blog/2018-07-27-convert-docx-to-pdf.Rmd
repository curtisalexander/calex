...
Recently, I had the need to convert a set (> 30) of Word documents `docx` to pdf.  Cobbling together pieces, I came up with a PowerShell script that takes advantage of the feature within Word to save a document as pdf.

As I have been wont to do of late, I turned this simple task into a more complete script, with [comment based help](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_comment_based_help?view=powershell-6), that I can share.  This serves two purposes for me.
